 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceService", targetNamespace = "http://service.bos/", wsdlLocation = "http://localhost:8080/crm/service/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICESERVICE_QNAME = new QName("http://service.bos/", "CustomerServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/crm/service/customer?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://service.bos/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.bos/", "CustomerServicePort"), CustomerService.class, features);
    }
