...
<script type="text/javascript">
	...
	function doExport(){
		window.location="subarea_outpitxls.action";
		//alert("导出");
	}
	...
	$(function(){
		...
		$("#btn").click(function(){
			var o=$("#searchSubareaForm").serializeObject();
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubAreaForm"  action="subarea_add.action" method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'name',url:'region_regList.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
