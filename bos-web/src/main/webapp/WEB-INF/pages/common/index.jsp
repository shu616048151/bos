...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			//校验表单
			$("#editPasswordForm").form("validate");
			...
			if(v1==v2){
				...
				$.post("user_editPassword.action",{'password':v1},function(data){
					...
					if(data=='1'){
						...
						$.messager.alert("修改密码","修改失败","error");
					}
				})
			}else{
				$.messager.alert("修改密码",'两次密码不一致',"warning");
			}
		});
	});
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: shuxibing@126.com");
	}
</script>
</head>
<body class="easyui-layout">
	...
	<div data-options="region:'south',border:false"
		...
		<div align="center">
						网站所有权：舒先生 &nbsp;&nbsp;联系地址：湖北省武汉市武汉理工大学<br>
						网站备案号：鄂ICP备18019888号
		</div>
	</div>
